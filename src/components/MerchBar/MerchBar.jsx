		...
		<Fragment>
			...
			<Container fluid className="p-3">
				<Row className="text-left ml-auto">
					<Col md={3}>
						<Card className="merch-card card-shadow">
					...
					<Col md={3}>
						<Card className="merch-card card-shadow">
							<a href="https://www.grinns.shop/products/golden-hour-vinyl">
								<Card.Img className="p-3" variant="top" src={"https://grinns-2021-s3-cfb.s3.amazonaws.com/merch/ghv.png"} />
							</a>
							<Card.Body className="">
								<Card.Text className="text-center text-white font-roboto">
									<i>
					...
					<Col md={3}>
						<Card className="merch-card card-shadow">
							<a href="https://www.grinns.shop/products/the-grinns-golden-hour">
								<Card.Img variant="top" src={"https://grinns-2021-s3-cfb.s3.amazonaws.com/merch/ghc.png"} />
							</a>
							<Card.Body className="">
								<Card.Text className="text-center text-white font-roboto">
									<i>
